...
public class ContactService implements Serializable {
	...
	public static Contact findContactByName (String nom){
		try {
			return (Contact) em.createNamedQuery("Contact.findContactByName").setParameter("nom", nom).getSingleResult();
		} catch (NoResultException e) {
			return null;
		}
	...
	public List<Contact> findActiveContact (){
		try {
			TypedQuery<Contact> query = em.createNamedQuery("Contact.findActiveContact", Contact.class);
			return query.getResultList();
